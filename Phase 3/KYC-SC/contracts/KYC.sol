...
contract KYC{
    ...
    // This function is used to add the KYC request to the kycRequests list. 
     ...
     // This function will add  customer to the customers list.
  ...
  // This function will remove the request from the kycRequests list.
   function removeRequest(string memory _customerName) public onlyValidBank{
    ...
    // This vote from a bank means  it accepts the customer details as well as acknowledges the KYC process done by some bank for the customer. 
    ...
    // This vote from a bank means  it does not accept the customer details.
    ...
    // This will remove  customer from the KYC request list and set the number of downvotes and upvotes to zero.
